...
Problem two combine three data set: data from Mr. Trash Wheel, Professor
Trash Wheel, and Gwynda Trash Wheel. The combined data set is **845**
rows by **15** columns. The data is separated by the amount of Plastic
Bottle, Polystyrene, Cigarette Butts, Glass Bottles, Plastic Bags,
Wrappers, and Sports Balls each vessel cleaned up. The total trash
Professor Trash Wheel cleaned up was **216.26** tons. The amount of
cigaretter butts Gwynnda picked up in June 2022 was **1.812^{4}** butts.
